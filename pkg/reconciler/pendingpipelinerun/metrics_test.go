...
func createPRs(g *WithT, t *testing.T, ctx context.Context, c *PendingCreate, client runtimeclient.Client, reconciler *ReconcilePendingPipelineRun, createTimes []metav1.Time) []v1beta1.PipelineRun {
...
func TestMetrics(t *testing.T) {
	...
	prs := createPRs(g, t, ctx, c, client, reconciler, nil)
	...
	prs = createPRs(g, t, ctx, c, client, reconciler, createTimes)
